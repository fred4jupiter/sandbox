...
public class InMemoryEmployeeDaoImpl implements EmployeeDao {
    ...
    static {
        ...
        List<Contact> contacts2 = new ArrayList<Contact>(2);
        contacts2.add(new Contact("phone1", "888-222-4444"));
        contacts2.add(new Contact("mobile", "222-111-3333"));

        List<Contact> contacts3 = new ArrayList<Contact>(2);
        contacts3.add(new Contact("pager", "999-333-8888"));
        contacts3.add(new Contact("cell", "999-111-6666"));

        employees = new ArrayList<Employee>();
        employees.add(new Employee(new Integer(1), "John", "Doe", contacts));
        employees.add(new Employee(new Integer(2), "Bob", "Smith", contacts2));
        employees.add(new Employee(new Integer(3), "Sue", "Boe", contacts3));
    }
